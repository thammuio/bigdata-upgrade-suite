...
if [ "${DRYRUN}x" == "x" ]; then
    sqoop-import -Dmapred.job.queuename=myq \
    ...
    --null-string '\002' \
    --map-column-java TBL_PARAM_VALUE=String \
    --hive-drop-import-delims
fi


# HOW TO RUN for Oracle
# ./hms_sqoop_dump.sh --target-hdfs-dir ${EXTERNAL_WAREHOUSE_DIR}/${TARGET_DB}.db/hms_dump_${DUMP_ENV} --jdbc-db-url jdbc:oracle:thin:@//hostname.com:1521/datalake_svc --jdbc-user DL_HIVE --jdbc-password Mypass --oracle
